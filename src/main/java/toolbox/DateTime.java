...
/**
 * Created by Superduo on 8/16/16.
 */
public class DateTime {
    ...
    public static void main(String[] args) {
        ...
        getSpecificDate(2004,5, 13);
        isSameDates(2004,10,23);
        isAnniversary(2016,4,16);
        getCurrentTime();
        addHours(16);
        addWeeks(34);
        subtractYears(2);
        getCurrnetUTCClock();
        getCurrnetLocalClock();
        isDateBefore(getCurrentDate(),getSpecificDate(2004,5,13));
        isDateAfter(getCurrentDate(),getSpecificDate(2009,4,16));
        isDateBetween(getSpecificDate(2016,3,16), getCurrentDate(), getSpecificDate(2016,4,16));
        daysBetweenDates(getCurrentDate(),getSpecificDate(2016,2,23));
        printAllTimeZones();
        getCurrentZonedDateTime("");
        howManyDaysInAMonth(2016,8);
        isLeapYear(4);
        defaultFormatting("");
        customFormatting("prettyDate");
